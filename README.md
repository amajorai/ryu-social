<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Outpost" width="144" />
  </picture>
</p>
...
A social-media command center: compose multi-segment posts against per-platform limits, schedule them onto a month/week/day calendar, and let a durable retrying publish queue push them to X, Bluesky, LinkedIn, Instagram, TikTok, YouTube, Reddit, Facebook and Threads, plus a reply inbox and engagement history.
...
**App:** [Install](ryu://apps/@ryu/social) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/social
```

**Crate:**

```bash
cargo install ryu-social
```
...
- **No `contributes.quotas`.** Nothing in `SocialSettings` is a plan-tier cap — they are
  ...
  to be wired to a plan quota to mean anything, so declaring
...
<a href="https://github.com/amajorai/ryu-social/stargazers">
  <picture>
